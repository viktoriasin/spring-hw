...
class TestServiceImplTest {
    ...
    void testCorrectStudentAnswer() {
        when(ioService.readIntForRangeWithPrompt(1, 3, "Enter your answer: ",
                "You must enter the number of one of the answer options"))
                .thenReturn(1);
    ...
    void testIncorrectStudentAnswer() {
        when(ioService.readIntForRangeWithPrompt(1, 3,
                "Enter your answer: ", "You must enter the number of one of the answer options"))
                .thenReturn(3);
